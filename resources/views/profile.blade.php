...
<div class="container" style=" padding-left: 500px">
    ...
    <form action="{{url('profile/'.$data->id)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="row" style="padding-left: 50px" >
            <img name="avatar"  src="{{asset('/storage/upload/'.$data->avatar)}}" style="height: 100px;width: 100px;" >
        </div>

        <label for="username">Username</label><br>
        <input type="text" name="username" value="{{$data->username}}" @if ($data->type == 'student') readonly @endif><br>
        <label for="name">Name</label><br>
        <input type="text"  name="name" value="{{$data->fullname}}" @if ($data->type == 'student') readonly @endif><br>
