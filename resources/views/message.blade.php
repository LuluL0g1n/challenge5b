...
<section>
    ...
    <div class="container" style=" padding-left: 500px">
        ...
        <form action="{{url('/message/'.$user->id)}}" method="post" enctype="multipart/form-data">

            <label for="username">Message</label><br>
            <input type="text" name="message" value="{{$user->message}}"><br>

            <input type="submit" class="Send Message" value="Send Message" name="update">
        </form>
    </div>
</section>
