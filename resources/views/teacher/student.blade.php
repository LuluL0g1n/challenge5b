...
<section>
    ...
    <table>
        ...
        <tr>
            ...
            <td>{{$usr->password}}</td>
            <td>{{$usr->phone}}</td>
            <td><button class="btn btn-primary"> <a style="color: #f7f7f7" href="{{url('/edit/'.$usr->id)}}"> Edit </a></button></td>
            <td><button  class="btn btn-primary"> <a style="color: #f7f7f7" href="{{url('/delete/'.$usr->id)}}"> Delete </a></button></td>
        </tr>
        @endforeach
...
<div class="container">
    <div class="row" style="padding-left: 30px">
        <div class="col" style="padding-left: 500px">
            <button class="btn btn-primary"> <a style="color: #f7f7f7" href="{{route('viewaddsv')}}"> Add account</a></button>
